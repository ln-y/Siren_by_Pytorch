...
class Siren(Server):
    def __init__(self,pretrained_data,root_train_data,acc_control=10):
...
class Siren_fltrust(Siren):
    def __init__(self, pretrained_data, root_train_data, acc_control=10):
        super(Siren_fltrust,self).__init__(pretrained_data, root_train_data, acc_control)
...
class Siren_PA(Siren):
    def __init__(self, pretrained_data, root_train_data, client_num,acc_control=10,Cp=4.5,Ca=0.5):
        '''
        ...
        '''
        super(Siren_PA,self).__init__(pretrained_data, root_train_data, acc_control)
