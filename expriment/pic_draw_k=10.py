...
def exp(client_num,malicious_num,communication_rounds,client_epchoes,non_IID_degree,Attack=fc.Sign_flipping,
    ...
    for i in range(communication_rounds):
        ...
        test_trainer.test()
    return test_trainer.test_accuracyL
    ...
    for j in range(len(attackL)):
        ...
        for i in range(len(defenceL)):
            for non_IID_degree in [0.1,0.5]:
                ...
                accL = exp(client_num, 4, communication_rounds, client_epchoes, non_IID_degree, attack, defence,
                           defence_dic)
                ...
                accL = exp(client_num, 8, communication_rounds, client_epchoes, non_IID_degree, attack, defence,
                           defence_dic)
